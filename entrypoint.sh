...
UUID=${UUID:-'b6616192-0fd7-4186-a9d3-2223535505c5'}
VMESS_WSPATH=${VMESS_WSPATH:-'/b6616192-0fd7-4186-a9d3-2223535505c5-vmess'}
VLESS_WSPATH=${VLESS_WSPATH:-'/b6616192-0fd7-4186-a9d3-2223535505c5-vless'}
TROJAN_WSPATH=${TROJAN_WSPATH:-'/b6616192-0fd7-4186-a9d3-2223535505c5-trojan'}
SS_WSPATH=${SS_WSPATH:-'/b6616192-0fd7-4186-a9d3-2223535505c5-shadowsocks'}
